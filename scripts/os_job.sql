...
-- ----------------------------
INSERT INTO `xxl_job_group` VALUES (1, 'user-executor', '用户执行器', 0, 'http://192.168.10.103:7722/,http://192.168.56.1:7722/', '2024-06-04 11:09:03');
INSERT INTO `xxl_job_group` VALUES (2, 'course-executor', '课程执行器', 0, 'http://192.168.10.103:7732/,http://192.168.56.1:7732/', '2024-06-04 11:09:03');
...
-- ----------------------------
INSERT INTO `xxl_job_info` VALUES (1, 1, '订单过期处理', '2018-11-03 22:21:31', '2022-09-30 22:29:21', 'roncoo', 'xxx@qq.com', 'FIX_RATE', '60', 'DO_NOTHING', 'RANDOM', 'orderJobHandler', '', 'DISCARD_LATER', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2018-11-03 22:21:31', '', 1, 1717470554346, 1717470614346);
...
INSERT INTO `xxl_job_info` VALUES (3, 2, '课程进度同步', '2022-09-25 14:02:42', '2024-03-14 09:38:48', 'roncoo', 'xxx@qq.com', 'FIX_RATE', '10', 'DO_NOTHING', 'RANDOM', 'userStudyJobHandler', '', 'DISCARD_LATER', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2022-09-25 14:02:42', '', 1, 1717470564346, 1717470574346);
INSERT INTO `xxl_job_info` VALUES (4, 2, '视频状态处理', '2023-06-08 14:59:28', '2024-03-14 09:31:14', 'roncoo', 'xxx@qq.com', 'FIX_RATE', '600', 'DO_NOTHING', 'RANDOM', 'resourceJobHandler', '', 'DISCARD_LATER', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2023-06-08 14:59:28', '', 1, 1717470161076, 1717470761076);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1961362 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 538 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `xxl_job_registry` VALUES (91, 'EXECUTOR', 'course-executor', 'http://192.168.10.103:7732/', '2024-06-04 11:09:38');
INSERT INTO `xxl_job_registry` VALUES (93, 'EXECUTOR', 'user-executor', 'http://192.168.10.103:7722/', '2024-06-04 11:09:39');
INSERT INTO `xxl_job_registry` VALUES (94, 'EXECUTOR', 'system-executor', 'http://192.168.10.103:7712/', '2024-06-04 11:09:39');
INSERT INTO `xxl_job_registry` VALUES (95, 'EXECUTOR', 'course-executor', 'http://192.168.56.1:7732/', '2024-06-04 11:09:19');
INSERT INTO `xxl_job_registry` VALUES (96, 'EXECUTOR', 'system-executor', 'http://192.168.56.1:7712/', '2024-06-04 11:09:28');
INSERT INTO `xxl_job_registry` VALUES (97, 'EXECUTOR', 'user-executor', 'http://192.168.56.1:7722/', '2024-06-04 11:09:38');
